...
sudo iptables -t nat -A PREROUTING -i eth0 -p tcp --dport 50022 -j DNAT --to 192.168.6.4:22



# DNAT everything else to FW Untrust except itself

sudo iptables -t nat -A PREROUTING -i eth0 \! -s 192.168.1.4 -j DNAT --to-destination 192.168.1.4
